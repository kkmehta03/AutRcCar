...
BACK_MOTOR_DATA_ONE = config.BACK_MOTOR_DATA_ONE
BACK_MOTOR_DATA_TWO = config.BACK_MOTOR_DATA_TWO
BACK_MOTOR_ENABLE_PIN = config.BACK_MOTOR_ENABLE_PIN
FRONT_MOTOR_DATA_ONE = config.FRONT_MOTOR_DATA_ONE
FRONT_MOTOR_DATA_TWO = config.FRONT_MOTOR_DATA_TWO
PWM_FREQUENCY = config.PWM_FREQUENCY
INITIAL_PWM_DUTY_CYCLE = config.INITIAL_PWM_DUTY_CYCLE
